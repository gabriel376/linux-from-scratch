...
sudo -u lfs /bin/bash - << EOF || exit 1
    env -i HOME=/home/lfs TERM=$TERM PS1='\u:\w\$ ' /bin/bash -c "
        ...
        run scripts/book/5.5-GCC-9.2.0-Pass-1.sh
        run scripts/book/5.6-Linux-5.2.8-API-Headers.sh
        run scripts/book/5.7-Glibc-2.30.sh
        run scripts/book/5.8-Libstdc++-from-GCC-9.2.0.sh
        run scripts/book/5.9-Binutils-2.32-Pass-2.sh
        run scripts/book/5.10-GCC-9.2.0-Pass-2.sh
        ...
        run scripts/book/5.17-Bison-3.4.1.sh
        run scripts/book/5.18-Bzip2-1.0.8.sh
        run scripts/book/5.19-Coreutils-8.31.sh
        run scripts/book/5.20-Diffutils-3.7.sh
        run scripts/book/5.21-File-5.37.sh
        run scripts/book/5.22-Findutils-4.6.0.sh
        run scripts/book/5.23-Gawk-5.0.1.sh
        run scripts/book/5.24-Gettext-0.20.1.sh
        ...
        run scripts/book/5.29-Perl-5.30.0.sh
        run scripts/book/5.30-Python-3.7.4.sh
        run scripts/book/5.31-Sed-4.7.sh
        run scripts/book/5.32-Tar-1.32.sh
        run scripts/book/5.33-Texinfo-6.6.sh
...
run scripts/book/6.7-Linux-5.2.8-API-Headers.sh
run scripts/book/6.8-Man-pages-5.02.sh
run scripts/book/6.9-Glibc-2.30.sh
run scripts/book/6.10-Adjusting-the-Toolchain.sh
run scripts/book/6.11-Zlib-1.2.11.sh
run scripts/book/6.12-File-5.37.sh
run scripts/book/6.13-Readline-8.0.sh
run scripts/book/6.14-M4-1.4.18.sh
run scripts/book/6.15-Bc-2.1.3.sh
...
run scripts/book/6.20-Shadow-4.7.sh
run scripts/book/6.21-GCC-9.2.0.sh
run scripts/book/6.22-Bzip2-1.0.8.sh
...
run scripts/book/6.38-Expat-2.2.7.sh
run scripts/book/6.39-Inetutils-1.9.4.sh
run scripts/book/6.40-Perl-5.30.0.sh
...
run scripts/book/6.47-Gettext-0.20.1.sh
run scripts/book/6.48-Libelf-from-Elfutils-0.177.sh
run scripts/book/6.49-Libffi-3.2.1.sh
run scripts/book/6.50-OpenSSL-1.1.1c.sh
run scripts/book/6.51-Python-3.7.4.sh
run scripts/book/6.52-Ninja-1.9.0.sh
run scripts/book/6.53-Meson-0.51.1.sh
run scripts/book/6.54-Coreutils-8.31.sh
run scripts/book/6.55-Check-0.12.0.sh
run scripts/book/6.56-Diffutils-3.7.sh
run scripts/book/6.57-Gawk-5.0.1.sh
run scripts/book/6.58-Findutils-4.6.0.sh
run scripts/book/6.59-Groff-1.22.4.sh
run scripts/book/6.60-GRUB-2.04.sh
run scripts/book/6.61-Less-551.sh
run scripts/book/6.62-Gzip-1.10.sh
run scripts/book/6.63-IPRoute2-5.2.0.sh
run scripts/book/6.64-Kbd-2.2.0.sh
run scripts/book/6.65-Libpipeline-1.5.1.sh
run scripts/book/6.66-Make-4.2.1.sh
run scripts/book/6.67-Patch-2.7.6.sh
run scripts/book/6.68-Man-DB-2.8.6.1.sh
run scripts/book/6.69-Tar-1.32.sh
run scripts/book/6.70-Texinfo-6.6.sh
run scripts/book/6.71-Vim-8.1.1846.sh
run scripts/book/6.72-Procps-ng-3.3.15.sh
run scripts/book/6.73-Util-linux-2.34.sh
run scripts/book/6.74-E2fsprogs-1.45.3.sh
run scripts/book/6.75-Sysklogd-1.5.1.sh
run scripts/book/6.76-Sysvinit-2.95.sh
run scripts/book/6.77-Eudev-3.2.8.sh
...
chroot "$LFS" /usr/bin/env -i          \
    ...
    /bin/bash --login -c "
source scripts/custom/utils.sh
run scripts/book/7.2-LFS-Bootscripts-20190524.sh
...
run scripts/book/8.3-Linux-5.2.8.sh
